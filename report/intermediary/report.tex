...
This is one of the best tools that we found and has greatly helped us in 
creating testing datasets and previewing a trained model with those tests. Despite all 
of this, it comes with a great dissadvantage: its a freemium model, you only get to train 
with a dataset for free three times total per project.
...
We've chosen the German Traffic Sign Recognition Benchmark[x] for our dataset.
...
\begin{figure}[h!]
    \centerline{\includegraphics[width=0.7\linewidth,]{overfit}}
